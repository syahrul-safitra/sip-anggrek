...
<head>
    ...
    <title>Posyandu Anggrek</title>
    <meta name="description" content="">
    <meta name="keywords" content="">

    <!-- Favicons -->
    <link href="{{ asset('user/assets/img/logo_posyandu.png') }}" rel="icon">
    ...
    <link rel="stylesheet" href="{{ asset('user/assets/css/datatables.min.css') }}">
...
<body class="index-page">
    ...
    <footer id="footer" class="footer position-relative light-background">
        ...
        <div class="copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Posyandu</strong> <span>Anggrek</span>
            </p>
            {{-- <div class="credits">
    ...
    <script src="{{ asset('user/my-script.js') }}"></script>
