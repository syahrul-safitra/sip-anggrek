        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-1">
                    <div class="card-body">
                        <h3 class="card-title text-white">Tumbuh Kembang Anak</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{ $tumbuhKABI }}</h2>
                            <p class="text-white mb-0">{{ 'Bulan ' . ' ' . date('m') . ' Tahun ' . date('Y') }}</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <div class="card-body">
                        <h3 class="card-title text-white">Tumbuh Kembang Anak</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{ $tumbuhKA }}</h2>
                            <p class="text-white mb-0">Tahun {{ date('Y') }}</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <div class="card-body">
                        <h3 class="card-title text-white">Imunisasi Pertahun</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{ $jumlahAnak }}</h2>
                            <p class="text-white mb-0">Tahun {{ date('Y') }}</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        <h3 class="card-title text-white">Jumlah Anak</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">{{ $jumlahAnak }}</h2>
                            <p class="text-white mb-0">_</p>
                        </div>
